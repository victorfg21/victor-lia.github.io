...
$(window).ready(function () {
	...
	$.vegas('slideshow', {
		backgrounds: [
			{
				src: 'https://i.ibb.co/9VVx9zL/11.jpg',
				fade: 1000
			},
			{
				src: 'https://i.ibb.co/YhL4PxK/10.jpg',
				fade: 1000
			},
			{
				src: 'https://i.ibb.co/YXGcHG8/7.jpg',
				fade: 1000
			}
		]
	})();
	...
	$('.view-project').on('click', function (e) {
		...
		setTimeout(function () {
			contentLoaded.load(href, function () {
				...
				contentLoaded.fadeIn(600).animate({
					'left': '0'
				}, {
					duration: 800,
					queue: false
